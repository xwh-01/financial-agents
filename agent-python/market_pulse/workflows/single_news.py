...
from market_pulse.analyzers.entity_event_resolver import resolve_entity_and_event
...
async def run_single_news_analysis(request: AnalyzeRequest) -> WorkflowResult:
    ...
    try:
        entity_result, event_result, risk_result = await resolve_entity_and_event(request)
